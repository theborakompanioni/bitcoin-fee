...
The [issue tracker](https://github.com/theborakompanioni/bitcoin-fee/issues) is
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/bitcoin-fee.git
   # Navigate to the newly cloned directory
   cd bitcoin-fee
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/theborakompanioni/bitcoin-fee.git
   ```
